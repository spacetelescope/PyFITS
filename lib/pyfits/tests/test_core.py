...
class TestFileFunctions(PyfitsTestCase):
    ...
    def test_uncloseable_file(self):
        ...
        with open(self.data('test0.fits'), 'rb') as f:
            ...
            with pyfits.open(fileobj) as hdul1:
                with pyfits.open(self.data('test0.fits')) as hdul2:
