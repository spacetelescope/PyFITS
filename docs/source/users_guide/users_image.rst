...
Data in each ``.section`` must be contiguous. Therefore, if ``f1[1].data`` is a 400x400 image, the first part of the following specifications will not work, while the second part will:
