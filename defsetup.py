...
try:
    import numpy
    ext_modules = [
                distutils.extension.Extension("pyfits.compression",
                     [
                    "src/compress.c",
...
setupargs = {
    ...
    'package_dir' :             { 'pyfits' : 'lib/pyfits', 'pyfits.hdu' : 'lib/pyfits/hdu', 'pyfits.tests' : 'lib/pyfits/tests' },
    'data_files' :              [ ( 'pyfits/tests/data', [ 'lib/pyfits/tests/data/*.fits' ] ) ],
